...
class CoordinatesMinichart extends PureComponent {
  ...
  onCreated = (evt) => {
    this.props.actions.addGeoLayer(this.props.fieldName, evt.layer);
  };

  onEdited = (evt) => {
    this.props.actions.editGeoLayers(this.props.fieldName, evt.layers);
  };

  onDeleted = (evt) => {
    this.props.actions.deleteGeoLayer(evt.layers);
  };
